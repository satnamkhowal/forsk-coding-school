...
$page_canonical='';
$page_schema='{"@context": "https://schema.org", "@type": "WebPage", "name": "Forsk Coding School - Forsk Coding School", "description": "Education LMS and Online course template", "url": "https://forskcodingschool.com/sign-in.php"}';
            ...
            <div class="row">
              <div class="col-12">
                <div class="tj-page-header-content">
                  <h1 class="tj-page-title">Sign in</h1>
              ...
              <div class="col-12">
                <div class="tj-login-form-wrapper tj-fade-anim">
                  ...
                  <div class="login-social">
                    <a class="tj-social-login-btn" href="sign-in.php#">
                      <span class="icon"><img src="assets/images/icons/google.svg" alt="Google"></span>
                  ...
                  <form class="tj-login-form" action="sign-in.php#" method="post">
                    ...
                    <div class="login-form-meta">
                      <label class="remember-check" for="remember-me">
                        ...
                        <span>I agree to the <a href="sign-in.php#">Privacy policy</a> and <a href="sign-in.php#">Terms of service</a></span>
                      </label>
                    </div>
                  ...
                  <p class="login-form-footer">Already have an account? <a href="login.php">Log in</a></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="product row ">
            ...
            <div class="col-12 col-md-6 summary entry-summary">
              ...
              <div class="summary-content ps-container ps-theme-wpc">
                ...
                <div class="tj-product-details-query-item d-flex align-items-center">
                  <span>Category: </span> <a href="sign-in.php#">Power</a>
                </div>
                <div class="tj-product-details-query-item d-flex align-items-center">
                  <span>Tag:</span> <a href="sign-in.php#">Portable</a>
                </div>
