...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="TLS HTTPS certificates and secure transport" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
