...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"PHP MVC architecture explained","description":"Learn php mvc architecture explained with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Fo...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/php-mvc-architecture-explained/"},"image":"https://forskcodingschool.com/blog/images/php-mvc-architecture-explained.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="PHP MVC architecture explained" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
