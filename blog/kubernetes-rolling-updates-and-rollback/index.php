...
$page_description = 'Learn Kubernetes rolling updates and rollback with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Kubernetes rolling updates and rollback","description":"Learn Kubernetes rolling updates and rollback with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/kubernetes-rolling-updates-and-rollback/"},"image":"https://forskcodingschool.com/blog/images/kubernetes-rolling-updates-and-rollback.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Kubernetes rolling updates and rollback" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
