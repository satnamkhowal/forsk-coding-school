...
$page_description = 'Learn Anomaly detection with machine learning with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Anomaly detection with machine learning","description":"Learn Anomaly detection with machine learning with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/anomaly-detection-with-machine-learning/"},"image":"https://forskcodingschool.com/blog/images/anomaly-detection-with-machine-learning.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Anomaly detection with machine learning" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
