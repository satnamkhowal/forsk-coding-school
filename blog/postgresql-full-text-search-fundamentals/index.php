...
$page_description = 'Learn PostgreSQL full text search fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"PostgreSQL full text search fundamentals","description":"Learn PostgreSQL full text search fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/postgresql-full-text-search-fundamentals/"},"image":"https://forskcodingschool.com/blog/images/postgresql-full-text-search-fundamentals.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="PostgreSQL full text search fundamentals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
