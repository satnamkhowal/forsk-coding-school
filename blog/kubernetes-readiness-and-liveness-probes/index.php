...
$page_description = 'Learn Kubernetes readiness and liveness probes with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Kubernetes readiness and liveness probes","description":"Learn Kubernetes readiness and liveness probes with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/kubernetes-readiness-and-liveness-probes/"},"image":"https://forskcodingschool.com/blog/images/kubernetes-readiness-and-liveness-probes.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Kubernetes readiness and liveness probes" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
