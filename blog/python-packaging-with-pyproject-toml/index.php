...
$page_description = 'Learn Python packaging with pyproject.toml with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Python packaging with pyproject.toml","description":"Learn Python packaging with pyproject.toml with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/python-packaging-with-pyproject-toml/"},"image":"https://forskcodingschool.com/blog/images/python-packaging-with-pyproject-toml.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Python packaging with pyproject.toml" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
