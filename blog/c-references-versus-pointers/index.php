...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"C++ references versus pointers","description":"Learn c++ references versus pointers with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Fo...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/c-references-versus-pointers/"},"image":"https://forskcodingschool.com/blog/images/c-references-versus-pointers.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="C++ references versus pointers" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
