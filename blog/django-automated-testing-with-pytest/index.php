...
$page_description = 'Learn Django automated testing with pytest with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Django automated testing with pytest","description":"Learn Django automated testing with pytest with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/django-automated-testing-with-pytest/"},"image":"https://forskcodingschool.com/blog/images/django-automated-testing-with-pytest.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Django automated testing with pytest" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
