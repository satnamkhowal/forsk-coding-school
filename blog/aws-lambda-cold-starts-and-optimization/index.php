...
$page_description = 'Learn AWS Lambda cold starts and optimization with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS Lambda cold starts and optimization","description":"Learn AWS Lambda cold starts and optimization with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-lambda-cold-starts-and-optimization/"},"image":"https://forskcodingschool.com/blog/images/aws-lambda-cold-starts-and-optimization.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS Lambda cold starts and optimization" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
