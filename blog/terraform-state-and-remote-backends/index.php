...
$page_description = 'Learn Terraform state and remote backends with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Terraform state and remote backends","description":"Learn Terraform state and remote backends with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/terraform-state-and-remote-backends/"},"image":"https://forskcodingschool.com/blog/images/terraform-state-and-remote-backends.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Terraform state and remote backends" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
