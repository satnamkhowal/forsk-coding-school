...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"WordPress enqueue scripts and styles correctly","description":"Learn wordpress enqueue scripts and styles correctly with practical explanations, examples, best practices, common mistakes and a clear implementation c...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/wordpress-enqueue-scripts-and-styles-correctly/"},"image":"https://forskcodingschool.com/blog/images/wordpress-enqueue-scripts-and-styles-correctly.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress enqueue scripts and styles correctly" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
