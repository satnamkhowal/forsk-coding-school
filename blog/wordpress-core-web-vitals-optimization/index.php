...
$page_description = 'Learn WordPress Core Web Vitals optimization with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"WordPress Core Web Vitals optimization","description":"Learn WordPress Core Web Vitals optimization with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/wordpress-core-web-vitals-optimization/"},"image":"https://forskcodingschool.com/blog/images/wordpress-core-web-vitals-optimization.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress Core Web Vitals optimization" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
