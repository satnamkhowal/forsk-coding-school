...
$page_description = 'Learn Azure Blob Storage lifecycle management with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Azure Blob Storage lifecycle management","description":"Learn Azure Blob Storage lifecycle management with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/azure-blob-storage-lifecycle-management/"},"image":"https://forskcodingschool.com/blog/images/azure-blob-storage-lifecycle-management.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure Blob Storage lifecycle management" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
