...
$page_description = 'Learn azure nsg rules and network security with practical explanations, examples, best practices, common mistakes and a clear implementation checklist f...';
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Azure NSG rules and network security" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
