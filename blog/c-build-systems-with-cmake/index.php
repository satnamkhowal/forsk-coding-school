...
$page_description = 'Learn C++ build systems with CMake with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"C++ build systems with CMake","description":"Learn C++ build systems with CMake with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/c-build-systems-with-cmake/"},"image":"https://forskcodingschool.com/blog/images/c-build-systems-with-cmake.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="C++ build systems with CMake" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
