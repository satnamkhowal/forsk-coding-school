...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="SQL database normalization with practical examples" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
