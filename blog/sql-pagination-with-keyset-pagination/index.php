...
$page_description = 'Learn SQL pagination with keyset pagination with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"SQL pagination with keyset pagination","description":"Learn SQL pagination with keyset pagination with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/sql-pagination-with-keyset-pagination/"},"image":"https://forskcodingschool.com/blog/images/sql-pagination-with-keyset-pagination.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="SQL pagination with keyset pagination" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
