...
$page_description = 'Learn WordPress image optimization workflow with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"WordPress image optimization workflow","description":"Learn WordPress image optimization workflow with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/wordpress-image-optimization-workflow/"},"image":"https://forskcodingschool.com/blog/images/wordpress-image-optimization-workflow.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress image optimization workflow" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
