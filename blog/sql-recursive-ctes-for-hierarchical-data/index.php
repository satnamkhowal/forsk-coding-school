...
$page_description = 'Learn SQL recursive CTEs for hierarchical data with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"SQL recursive CTEs for hierarchical data","description":"Learn SQL recursive CTEs for hierarchical data with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/sql-recursive-ctes-for-hierarchical-data/"},"image":"https://forskcodingschool.com/blog/images/sql-recursive-ctes-for-hierarchical-data.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="SQL recursive CTEs for hierarchical data" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
