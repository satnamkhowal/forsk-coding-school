...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="JavaScript date and time handling pitfalls" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
