...
$page_description = 'Learn Java immutability and defensive copying with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Java immutability and defensive copying","description":"Learn Java immutability and defensive copying with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/java-immutability-and-defensive-copying/"},"image":"https://forskcodingschool.com/blog/images/java-immutability-and-defensive-copying.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Java immutability and defensive copying" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
