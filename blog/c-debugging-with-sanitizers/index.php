...
$page_description = 'Learn C++ debugging with sanitizers with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"C++ debugging with sanitizers","description":"Learn C++ debugging with sanitizers with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/c-debugging-with-sanitizers/"},"image":"https://forskcodingschool.com/blog/images/c-debugging-with-sanitizers.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="C++ debugging with sanitizers" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
