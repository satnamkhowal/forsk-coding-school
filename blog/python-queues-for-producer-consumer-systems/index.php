...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Python queues for producer consumer systems" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
