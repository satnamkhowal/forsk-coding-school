...
$page_description = 'Learn frontend progressive enhancement strategy with practical explanations, examples, best practices, common mistakes and a clear implementation checkl...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Frontend progressive enhancement strategy', 'description': 'Learn frontend progressive enhancement strategy with practical explanations, examples, best practices, common mistakes and a clear implementation checkl...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/frontend-progressive-enhancement-strategy/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/frontend-progressive-enhancement-strategy.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Frontend progressive enhancement strategy" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
