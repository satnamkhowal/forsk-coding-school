...
$page_description = 'Learn Postman collections for API testing with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Postman collections for API testing","description":"Learn Postman collections for API testing with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/postman-collections-for-api-testing/"},"image":"https://forskcodingschool.com/blog/images/postman-collections-for-api-testing.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Postman collections for API testing" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
