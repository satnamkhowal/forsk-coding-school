...
$page_description = 'Learn Azure Logic Apps workflow automation with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Azure Logic Apps workflow automation","description":"Learn Azure Logic Apps workflow automation with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/azure-logic-apps-workflow-automation/"},"image":"https://forskcodingschool.com/blog/images/azure-logic-apps-workflow-automation.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure Logic Apps workflow automation" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
