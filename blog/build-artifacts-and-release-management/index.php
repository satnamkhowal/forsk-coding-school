...
$page_description = 'Learn build artifacts and release management with practical explanations, examples, best practices, common mistakes and a clear implementation checklist...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Build artifacts and release management', 'description': 'Learn build artifacts and release management with practical explanations, examples, best practices, common mistakes and a clear implementation checklist...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/build-artifacts-and-release-management/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/build-artifacts-and-release-management.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Build artifacts and release management" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
