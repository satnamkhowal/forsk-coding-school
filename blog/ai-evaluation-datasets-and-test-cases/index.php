...
$page_description = 'Learn AI evaluation datasets and test cases with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AI evaluation datasets and test cases","description":"Learn AI evaluation datasets and test cases with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/ai-evaluation-datasets-and-test-cases/"},"image":"https://forskcodingschool.com/blog/images/ai-evaluation-datasets-and-test-cases.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AI evaluation datasets and test cases" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
