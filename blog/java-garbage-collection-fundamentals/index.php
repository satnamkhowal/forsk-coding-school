...
$page_description = 'Learn Java garbage collection fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Java garbage collection fundamentals","description":"Learn Java garbage collection fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/java-garbage-collection-fundamentals/"},"image":"https://forskcodingschool.com/blog/images/java-garbage-collection-fundamentals.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Java garbage collection fundamentals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
