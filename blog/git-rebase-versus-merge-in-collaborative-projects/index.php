...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Git rebase versus merge in collaborative projects","description":"Learn git rebase versus merge in collaborative projects with practical explanations, examples, best practices, common mistakes and a clear implementatio...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/git-rebase-versus-merge-in-collaborative-projects/"},"image":"https://forskcodingschool.com/blog/images/git-rebase-versus-merge-in-collaborative-projects.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Git rebase versus merge in collaborative projects" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
