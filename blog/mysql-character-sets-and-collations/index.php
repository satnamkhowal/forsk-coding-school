...
$page_description = 'Learn MySQL character sets and collations with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"MySQL character sets and collations","description":"Learn MySQL character sets and collations with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/mysql-character-sets-and-collations/"},"image":"https://forskcodingschool.com/blog/images/mysql-character-sets-and-collations.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="MySQL character sets and collations" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
