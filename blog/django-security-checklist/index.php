...
$page_description = 'Learn django security checklist with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Forsk C...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Django security checklist', 'description': 'Learn django security checklist with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Forsk C...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/django-security-checklist/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/django-security-checklist.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Django security checklist" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
