...
$page_title = 'Django security checklist';
$page_description = 'Learn Django security checklist with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
$page_keywords = 'Django development';
$slug = 'django-security-checklist';
$page_canonical = blog_url($slug);
$page_og_image = blog_image_url($slug . '.webp');
$page_schema = <<<'FORSK_JSON'
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Django security checklist","description":"Learn Django security checklist with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/django-security-checklist/"},"image":"https://forskcodingschool.com/blog/images/django-security-checklist.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<ul><li><a href="<?= blog_url('django-csrf-protection-explained') ?>">Django CSRF protection explained</a></li><li><a href="<?= blog_url('php-psr-standards-for-maintainable-code') ?>">PHP PSR standards for maintainable code</a></li><li><a href="<?= blog_url('wordpress-hooks-actions-and-filters-guide') ?>">WordPress hooks actions and filters</a></li></ul>
