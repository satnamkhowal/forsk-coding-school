...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS stacking contexts and z-index","description":"Learn css stacking contexts and z-index with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-stacking-contexts-and-z-index/"},"image":"https://forskcodingschool.com/blog/images/css-stacking-contexts-and-z-index.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS stacking contexts and z-index" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
