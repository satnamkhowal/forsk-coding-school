...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Node.js real-time notification architecture","description":"Learn node.js real-time notification architecture with practical explanations, examples, best practices, common mistakes and a clear implementation chec...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/node-js-real-time-notification-architecture/"},"image":"https://forskcodingschool.com/blog/images/node-js-real-time-notification-architecture.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Node.js real-time notification architecture" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
