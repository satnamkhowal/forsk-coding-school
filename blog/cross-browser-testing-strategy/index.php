...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Cross browser testing strategy","description":"Learn cross browser testing strategy with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Fo...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/cross-browser-testing-strategy/"},"image":"https://forskcodingschool.com/blog/images/cross-browser-testing-strategy.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Cross browser testing strategy" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
