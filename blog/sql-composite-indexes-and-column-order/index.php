...
$page_description = 'Learn SQL composite indexes and column order with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"SQL composite indexes and column order","description":"Learn SQL composite indexes and column order with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/sql-composite-indexes-and-column-order/"},"image":"https://forskcodingschool.com/blog/images/sql-composite-indexes-and-column-order.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="SQL composite indexes and column order" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
