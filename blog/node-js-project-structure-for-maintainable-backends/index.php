...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Node.js project structure for maintainable backends" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
