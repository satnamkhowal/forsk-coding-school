...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Frontend performance budgets and Core Web Vitals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
