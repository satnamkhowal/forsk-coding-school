...
$page_description = 'Learn Security testing basics for QA teams with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Security testing basics for QA teams","description":"Learn Security testing basics for QA teams with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/security-testing-basics-for-qa-teams/"},"image":"https://forskcodingschool.com/blog/images/security-testing-basics-for-qa-teams.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Security testing basics for QA teams" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
