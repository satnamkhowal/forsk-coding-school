...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Docker multi stage builds","description":"Learn docker multi stage builds with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Forsk C...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/docker-multi-stage-builds/"},"image":"https://forskcodingschool.com/blog/images/docker-multi-stage-builds.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Docker multi stage builds" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
