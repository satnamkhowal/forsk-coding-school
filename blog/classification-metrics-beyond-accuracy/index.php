...
$page_description = 'Learn classification metrics beyond accuracy with practical explanations, examples, best practices, common mistakes and a clear implementation checklist...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Classification metrics beyond accuracy', 'description': 'Learn classification metrics beyond accuracy with practical explanations, examples, best practices, common mistakes and a clear implementation checklist...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/classification-metrics-beyond-accuracy/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/classification-metrics-beyond-accuracy.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Classification metrics beyond accuracy" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
