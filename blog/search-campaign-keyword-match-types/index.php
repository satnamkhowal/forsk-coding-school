...
$page_description = 'Learn Search campaign keyword match types with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Search campaign keyword match types","description":"Learn Search campaign keyword match types with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/search-campaign-keyword-match-types/"},"image":"https://forskcodingschool.com/blog/images/search-campaign-keyword-match-types.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Search campaign keyword match types" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
