...
$page_description = 'Learn C++ smart pointers ownership models with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"C++ smart pointers ownership models","description":"Learn C++ smart pointers ownership models with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/c-smart-pointers-ownership-models/"},"image":"https://forskcodingschool.com/blog/images/c-smart-pointers-ownership-models.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="C++ smart pointers ownership models" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
