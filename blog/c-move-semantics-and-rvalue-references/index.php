...
$page_description = 'Learn C++ move semantics and rvalue references with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"C++ move semantics and rvalue references","description":"Learn C++ move semantics and rvalue references with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/c-move-semantics-and-rvalue-references/"},"image":"https://forskcodingschool.com/blog/images/c-move-semantics-and-rvalue-references.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="C++ move semantics and rvalue references" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
