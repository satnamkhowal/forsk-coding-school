...
$page_description = 'Learn django models and database relationships with practical explanations, examples, best practices, common mistakes and a clear implementation checkli...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Django models and database relationships', 'description': 'Learn django models and database relationships with practical explanations, examples, best practices, common mistakes and a clear implementation checkli...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/django-models-and-database-relationships/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/django-models-and-database-relationships.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Django models and database relationships" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
