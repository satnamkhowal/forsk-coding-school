...
$page_description = 'Learn Prompt engineering for reliable outputs with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Prompt engineering for reliable outputs","description":"Learn Prompt engineering for reliable outputs with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/prompt-engineering-for-reliable-outputs/"},"image":"https://forskcodingschool.com/blog/images/prompt-engineering-for-reliable-outputs.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Prompt engineering for reliable outputs" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
