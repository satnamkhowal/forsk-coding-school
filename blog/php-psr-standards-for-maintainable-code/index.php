...
$page_description = 'Learn PHP PSR standards for maintainable code with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"PHP PSR standards for maintainable code","description":"Learn PHP PSR standards for maintainable code with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/php-psr-standards-for-maintainable-code/"},"image":"https://forskcodingschool.com/blog/images/php-psr-standards-for-maintainable-code.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="PHP PSR standards for maintainable code" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
