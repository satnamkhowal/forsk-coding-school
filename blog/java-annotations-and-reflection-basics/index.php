...
$page_description = 'Learn Java annotations and reflection basics with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Java annotations and reflection basics","description":"Learn Java annotations and reflection basics with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/java-annotations-and-reflection-basics/"},"image":"https://forskcodingschool.com/blog/images/java-annotations-and-reflection-basics.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Java annotations and reflection basics" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
