...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Django project settings for multiple environments","description":"Learn django project settings for multiple environments with practical explanations, examples, best practices, common mistakes and a clear implementatio...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/django-project-settings-for-multiple-environments/"},"image":"https://forskcodingschool.com/blog/images/django-project-settings-for-multiple-environments.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Django project settings for multiple environments" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
