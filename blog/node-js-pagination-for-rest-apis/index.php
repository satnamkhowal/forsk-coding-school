...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Node.js pagination for REST APIs" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
