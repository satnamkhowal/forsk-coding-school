...
$page_description = 'Learn Function calling and tool use patterns with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Function calling and tool use patterns","description":"Learn Function calling and tool use patterns with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/function-calling-and-tool-use-patterns/"},"image":"https://forskcodingschool.com/blog/images/function-calling-and-tool-use-patterns.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Function calling and tool use patterns" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
