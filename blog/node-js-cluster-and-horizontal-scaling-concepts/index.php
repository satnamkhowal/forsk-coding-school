...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Node.js cluster and horizontal scaling concepts" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
