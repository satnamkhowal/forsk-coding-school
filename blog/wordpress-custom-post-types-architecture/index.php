...
$page_description = 'Learn WordPress custom post types architecture with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"WordPress custom post types architecture","description":"Learn WordPress custom post types architecture with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/wordpress-custom-post-types-architecture/"},"image":"https://forskcodingschool.com/blog/images/wordpress-custom-post-types-architecture.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress custom post types architecture" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
