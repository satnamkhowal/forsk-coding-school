...
$page_description = 'Learn PHP testing with PHPUnit with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"PHP testing with PHPUnit","description":"Learn PHP testing with PHPUnit with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/php-testing-with-phpunit/"},"image":"https://forskcodingschool.com/blog/images/php-testing-with-phpunit.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="PHP testing with PHPUnit" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
