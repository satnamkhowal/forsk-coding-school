...
$page_description = 'Learn topical authority and content clusters with practical explanations, examples, best practices, common mistakes and a clear implementation checklist...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Topical authority and content clusters', 'description': 'Learn topical authority and content clusters with practical explanations, examples, best practices, common mistakes and a clear implementation checklist...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/topical-authority-and-content-clusters/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/topical-authority-and-content-clusters.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Topical authority and content clusters" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
