...
$page_description = 'Learn WordPress REST API fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"WordPress REST API fundamentals","description":"Learn WordPress REST API fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/wordpress-rest-api-fundamentals/"},"image":"https://forskcodingschool.com/blog/images/wordpress-rest-api-fundamentals.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress REST API fundamentals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
