...
$page_description = 'Learn JavaScript spread versus rest syntax with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"JavaScript spread versus rest syntax","description":"Learn JavaScript spread versus rest syntax with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/javascript-spread-versus-rest-syntax/"},"image":"https://forskcodingschool.com/blog/images/javascript-spread-versus-rest-syntax.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="JavaScript spread versus rest syntax" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
