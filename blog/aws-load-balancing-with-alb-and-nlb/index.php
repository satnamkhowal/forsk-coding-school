...
$page_description = 'Learn AWS load balancing with ALB and NLB with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS load balancing with ALB and NLB","description":"Learn AWS load balancing with ALB and NLB with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-load-balancing-with-alb-and-nlb/"},"image":"https://forskcodingschool.com/blog/images/aws-load-balancing-with-alb-and-nlb.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS load balancing with ALB and NLB" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
