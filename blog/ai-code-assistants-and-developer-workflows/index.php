...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AI code assistants and developer workflows" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
