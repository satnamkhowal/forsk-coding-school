...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS reduced motion accessibility","description":"Learn css reduced motion accessibility with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-reduced-motion-accessibility/"},"image":"https://forskcodingschool.com/blog/images/css-reduced-motion-accessibility.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS reduced motion accessibility" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
