...
$page_description = 'Learn CSS custom properties for design tokens with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS custom properties for design tokens","description":"Learn CSS custom properties for design tokens with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-custom-properties-for-design-tokens/"},"image":"https://forskcodingschool.com/blog/images/css-custom-properties-for-design-tokens.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS custom properties for design tokens" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
