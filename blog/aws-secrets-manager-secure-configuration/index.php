...
$page_description = 'Learn AWS Secrets Manager secure configuration with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS Secrets Manager secure configuration","description":"Learn AWS Secrets Manager secure configuration with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-secrets-manager-secure-configuration/"},"image":"https://forskcodingschool.com/blog/images/aws-secrets-manager-secure-configuration.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS Secrets Manager secure configuration" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
