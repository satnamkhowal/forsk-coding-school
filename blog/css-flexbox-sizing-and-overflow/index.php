...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS flexbox sizing and overflow","description":"Learn css flexbox sizing and overflow with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from F...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-flexbox-sizing-and-overflow/"},"image":"https://forskcodingschool.com/blog/images/css-flexbox-sizing-and-overflow.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS flexbox sizing and overflow" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
