...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Jupyter notebook best practices" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
