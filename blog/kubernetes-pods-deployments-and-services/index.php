...
$page_description = 'Learn Kubernetes pods deployments and services with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Kubernetes pods deployments and services","description":"Learn Kubernetes pods deployments and services with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/kubernetes-pods-deployments-and-services/"},"image":"https://forskcodingschool.com/blog/images/kubernetes-pods-deployments-and-services.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Kubernetes pods deployments and services" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
