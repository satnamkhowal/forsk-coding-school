...
$page_description = 'Learn C++ performance profiling fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"C++ performance profiling fundamentals","description":"Learn C++ performance profiling fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/c-performance-profiling-fundamentals/"},"image":"https://forskcodingschool.com/blog/images/c-performance-profiling-fundamentals.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="C++ performance profiling fundamentals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
