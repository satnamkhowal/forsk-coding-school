...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="SQL common table expressions for readable queries" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
