...
$page_description = 'Learn Digital marketing funnel explained with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
$page_keywords = 'digital marketing';
$slug = 'digital-marketing-funnel-explained-guide';
$page_canonical = blog_url('digital-marketing-funnel-explained');
$page_robots = 'noindex, follow';
$page_og_image = blog_image_url($slug . '.webp');
$page_schema = <<<'FORSK_JSON'
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Digital marketing funnel explained","description":"Learn Digital marketing funnel explained with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/digital-marketing-funnel-explained-guide/"},"image":"https://forskcodingschool.com/blog/images/digital-marketing-funnel-explained-guide.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Digital marketing funnel explained" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
