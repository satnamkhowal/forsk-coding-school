...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="SQL stored procedures and when to use them" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
