...
$page_description = 'Learn java enums with behavior and state with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fro...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Java enums with behavior and state', 'description': 'Learn java enums with behavior and state with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fro...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/java-enums-with-behavior-and-state/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/java-enums-with-behavior-and-state.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Java enums with behavior and state" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
