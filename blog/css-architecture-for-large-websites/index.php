...
$page_description = 'Learn CSS architecture for large websites with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS architecture for large websites","description":"Learn CSS architecture for large websites with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-architecture-for-large-websites/"},"image":"https://forskcodingschool.com/blog/images/css-architecture-for-large-websites.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS architecture for large websites" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
