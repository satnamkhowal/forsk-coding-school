...
$page_description = 'Learn AWS security groups versus network ACLs with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS security groups versus network ACLs","description":"Learn AWS security groups versus network ACLs with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-security-groups-versus-network-acls/"},"image":"https://forskcodingschool.com/blog/images/aws-security-groups-versus-network-acls.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS security groups versus network ACLs" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
