...
$page_description = 'Learn WordPress transient API for caching with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"WordPress transient API for caching","description":"Learn WordPress transient API for caching with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/wordpress-transient-api-for-caching/"},"image":"https://forskcodingschool.com/blog/images/wordpress-transient-api-for-caching.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress transient API for caching" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
