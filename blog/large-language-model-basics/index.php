...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Large language model basics" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
