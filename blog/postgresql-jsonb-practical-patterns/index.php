...
$page_description = 'Learn PostgreSQL JSONB practical patterns with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"PostgreSQL JSONB practical patterns","description":"Learn PostgreSQL JSONB practical patterns with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/postgresql-jsonb-practical-patterns/"},"image":"https://forskcodingschool.com/blog/images/postgresql-jsonb-practical-patterns.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="PostgreSQL JSONB practical patterns" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
