...
$page_description = 'Learn AWS EventBridge event driven architecture with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS EventBridge event driven architecture","description":"Learn AWS EventBridge event driven architecture with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-eventbridge-event-driven-architecture/"},"image":"https://forskcodingschool.com/blog/images/aws-eventbridge-event-driven-architecture.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS EventBridge event driven architecture" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
