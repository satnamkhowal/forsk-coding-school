...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress custom fields strategy" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
