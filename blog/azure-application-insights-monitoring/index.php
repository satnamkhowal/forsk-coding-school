...
$page_description = 'Learn Azure Application Insights monitoring with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Azure Application Insights monitoring","description":"Learn Azure Application Insights monitoring with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/azure-application-insights-monitoring/"},"image":"https://forskcodingschool.com/blog/images/azure-application-insights-monitoring.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure Application Insights monitoring" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
