...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'JavaScript debouncing and throttling', 'description': 'Learn javascript debouncing and throttling with practical explanations, examples, best practices, common mistakes and a clear implementation checklist f...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/javascript-debouncing-and-throttling/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/javascript-debouncing-and-throttling.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<ul><li><a href="<?= blog_url('javascript-promises-error-handling-patterns') ?>">JavaScript promises error handling patterns</a></li><li><a href="<?= blog_url('javascript-array-methods-for-data-transformation') ?>">JavaScript array methods for data transformation</a></li><li><a href="<?= blog_url('css-grid-auto-placement-strategies') ?>">CSS grid auto placement strategies</a></li></ul>
