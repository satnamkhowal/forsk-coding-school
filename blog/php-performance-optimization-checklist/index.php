...
$page_description = 'Learn PHP performance optimization checklist with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"PHP performance optimization checklist","description":"Learn PHP performance optimization checklist with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/php-performance-optimization-checklist/"},"image":"https://forskcodingschool.com/blog/images/php-performance-optimization-checklist.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="PHP performance optimization checklist" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
