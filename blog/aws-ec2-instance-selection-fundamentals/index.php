...
$page_description = 'Learn AWS EC2 instance selection fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS EC2 instance selection fundamentals","description":"Learn AWS EC2 instance selection fundamentals with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-ec2-instance-selection-fundamentals/"},"image":"https://forskcodingschool.com/blog/images/aws-ec2-instance-selection-fundamentals.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS EC2 instance selection fundamentals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
