...
$page_description = 'Learn Azure App Service deployment patterns with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Azure App Service deployment patterns","description":"Learn Azure App Service deployment patterns with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/azure-app-service-deployment-patterns/"},"image":"https://forskcodingschool.com/blog/images/azure-app-service-deployment-patterns.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure App Service deployment patterns" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
