...
$page_description = 'Learn Java collectors for custom reductions with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Java collectors for custom reductions","description":"Learn Java collectors for custom reductions with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/java-collectors-for-custom-reductions/"},"image":"https://forskcodingschool.com/blog/images/java-collectors-for-custom-reductions.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Java collectors for custom reductions" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
