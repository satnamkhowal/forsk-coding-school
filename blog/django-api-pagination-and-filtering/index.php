...
$page_description = 'Learn Django API pagination and filtering with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Django API pagination and filtering","description":"Learn Django API pagination and filtering with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/django-api-pagination-and-filtering/"},"image":"https://forskcodingschool.com/blog/images/django-api-pagination-and-filtering.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Django API pagination and filtering" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
