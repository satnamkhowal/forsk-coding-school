...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS transitions versus animations","description":"Learn css transitions versus animations with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-transitions-versus-animations/"},"image":"https://forskcodingschool.com/blog/images/css-transitions-versus-animations.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS transitions versus animations" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
