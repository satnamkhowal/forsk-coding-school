...
$page_description = 'Learn Threat modeling for web applications with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Threat modeling for web applications","description":"Learn Threat modeling for web applications with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/threat-modeling-for-web-applications/"},"image":"https://forskcodingschool.com/blog/images/threat-modeling-for-web-applications.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Threat modeling for web applications" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
