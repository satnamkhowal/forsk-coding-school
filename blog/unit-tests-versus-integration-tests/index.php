...
$page_description = 'Learn unit tests versus integration tests with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fr...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Unit tests versus integration tests', 'description': 'Learn unit tests versus integration tests with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fr...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/unit-tests-versus-integration-tests/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/unit-tests-versus-integration-tests.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Unit tests versus integration tests" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
