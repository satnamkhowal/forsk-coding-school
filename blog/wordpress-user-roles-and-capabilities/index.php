...
$page_description = 'Learn WordPress user roles and capabilities with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"WordPress user roles and capabilities","description":"Learn WordPress user roles and capabilities with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/wordpress-user-roles-and-capabilities/"},"image":"https://forskcodingschool.com/blog/images/wordpress-user-roles-and-capabilities.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress user roles and capabilities" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
