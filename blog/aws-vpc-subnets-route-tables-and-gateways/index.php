...
$page_description = 'Learn AWS VPC subnets route tables and gateways with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS VPC subnets route tables and gateways","description":"Learn AWS VPC subnets route tables and gateways with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-vpc-subnets-route-tables-and-gateways/"},"image":"https://forskcodingschool.com/blog/images/aws-vpc-subnets-route-tables-and-gateways.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS VPC subnets route tables and gateways" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
