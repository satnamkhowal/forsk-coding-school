...
$page_description = 'Learn RAG evaluation and retrieval quality with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"RAG evaluation and retrieval quality","description":"Learn RAG evaluation and retrieval quality with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/rag-evaluation-and-retrieval-quality/"},"image":"https://forskcodingschool.com/blog/images/rag-evaluation-and-retrieval-quality.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="RAG evaluation and retrieval quality" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
