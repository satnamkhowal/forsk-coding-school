...
$page_title = 'Node.js testing APIs with integration tests';
$page_description = 'Learn node.js testing apis with integration tests with practical explanations, examples, best practices, common mistakes and a clear implementation chec...';
$page_keywords = 'Node.js development';
$slug = 'node-js-testing-apis-with-integration-tests';
$page_canonical = blog_url($slug);
$page_og_image = asset_url('images/blog/' . $slug . '.webp');
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Node.js testing APIs with integration tests', 'description': 'Learn node.js testing apis with integration tests with practical explanations, examples, best practices, common mistakes and a clear implementation chec...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/node-js-testing-apis-with-integration-tests/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/node-js-testing-apis-with-integration-tests.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
