...
$page_description = 'Learn Node.js testing APIs with integration tests with practical examples, project guidance and related Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Node.js testing APIs with integration tests","description":"Learn Node.js testing APIs with integration tests with practical examples, project guidance and related Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/node-js-testing-apis-with-integration-tests/"},"image":"https://forskcodingschool.com/blog/images/node-js-testing-apis-with-integration-tests.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Node.js testing APIs with integration tests" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
