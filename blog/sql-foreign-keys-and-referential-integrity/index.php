...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"SQL foreign keys and referential integrity","description":"Learn sql foreign keys and referential integrity with practical explanations, examples, best practices, common mistakes and a clear implementation check...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/sql-foreign-keys-and-referential-integrity/"},"image":"https://forskcodingschool.com/blog/images/sql-foreign-keys-and-referential-integrity.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="SQL foreign keys and referential integrity" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
