...
$page_description = 'Learn Azure Event Grid event driven systems with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Azure Event Grid event driven systems","description":"Learn Azure Event Grid event driven systems with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/azure-event-grid-event-driven-systems/"},"image":"https://forskcodingschool.com/blog/images/azure-event-grid-event-driven-systems.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure Event Grid event driven systems" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
