...
$page_description = 'Learn Git branching strategies for small teams with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Git branching strategies for small teams","description":"Learn Git branching strategies for small teams with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/git-branching-strategies-for-small-teams/"},"image":"https://forskcodingschool.com/blog/images/git-branching-strategies-for-small-teams.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Git branching strategies for small teams" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
