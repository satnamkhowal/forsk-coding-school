...
$page_description = 'Learn AWS IAM policies and least privilege with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS IAM policies and least privilege","description":"Learn AWS IAM policies and least privilege with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-iam-policies-and-least-privilege/"},"image":"https://forskcodingschool.com/blog/images/aws-iam-policies-and-least-privilege.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS IAM policies and least privilege" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
