...
$page_description = 'Learn Docker health checks and restart policies with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Docker health checks and restart policies","description":"Learn Docker health checks and restart policies with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/docker-health-checks-and-restart-policies/"},"image":"https://forskcodingschool.com/blog/images/docker-health-checks-and-restart-policies.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Docker health checks and restart policies" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
