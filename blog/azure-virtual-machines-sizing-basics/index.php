...
$page_description = 'Learn Azure virtual machines sizing basics with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Azure virtual machines sizing basics","description":"Learn Azure virtual machines sizing basics with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/azure-virtual-machines-sizing-basics/"},"image":"https://forskcodingschool.com/blog/images/azure-virtual-machines-sizing-basics.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure virtual machines sizing basics" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
