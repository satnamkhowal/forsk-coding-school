...
$page_description = 'Learn java serialization alternatives and risks with practical explanations, examples, best practices, common mistakes and a clear implementation checkl...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Java serialization alternatives and risks', 'description': 'Learn java serialization alternatives and risks with practical explanations, examples, best practices, common mistakes and a clear implementation checkl...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/java-serialization-alternatives-and-risks/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/java-serialization-alternatives-and-risks.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Java serialization alternatives and risks" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
