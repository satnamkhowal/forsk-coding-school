...
$page_description = 'Learn Java streams grouping and partitioning with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Java streams grouping and partitioning","description":"Learn Java streams grouping and partitioning with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/java-streams-grouping-and-partitioning/"},"image":"https://forskcodingschool.com/blog/images/java-streams-grouping-and-partitioning.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Java streams grouping and partitioning" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
