...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS subgrid for aligned layouts","description":"Learn css subgrid for aligned layouts with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from F...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-subgrid-for-aligned-layouts/"},"image":"https://forskcodingschool.com/blog/images/css-subgrid-for-aligned-layouts.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS subgrid for aligned layouts" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
