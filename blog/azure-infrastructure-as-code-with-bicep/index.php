...
$page_description = 'Learn Azure infrastructure as code with Bicep with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure infrastructure as code with Bicep" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
