...
$page_description = 'Learn Kubernetes ConfigMaps and Secrets with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
$page_keywords = 'DevOps';
$slug = 'kubernetes-configmaps-and-secrets-guide';
$page_canonical = blog_url('kubernetes-configmaps-and-secrets');
$page_robots = 'noindex, follow';
$page_og_image = blog_image_url($slug . '.webp');
$page_schema = <<<'FORSK_JSON'
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Kubernetes ConfigMaps and Secrets","description":"Learn Kubernetes ConfigMaps and Secrets with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/kubernetes-configmaps-and-secrets-guide/"},"image":"https://forskcodingschool.com/blog/images/kubernetes-configmaps-and-secrets-guide.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Kubernetes ConfigMaps and Secrets" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
