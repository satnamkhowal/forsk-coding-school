...
$page_description = 'Learn PHP typed properties and strict types with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"PHP typed properties and strict types","description":"Learn PHP typed properties and strict types with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/php-typed-properties-and-strict-types/"},"image":"https://forskcodingschool.com/blog/images/php-typed-properties-and-strict-types.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="PHP typed properties and strict types" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
