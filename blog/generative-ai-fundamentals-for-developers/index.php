...
$page_description = 'Learn Generative AI fundamentals for developers with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Generative AI fundamentals for developers","description":"Learn Generative AI fundamentals for developers with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/generative-ai-fundamentals-for-developers/"},"image":"https://forskcodingschool.com/blog/images/generative-ai-fundamentals-for-developers.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Generative AI fundamentals for developers" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
