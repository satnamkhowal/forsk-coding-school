...
$page_title = 'Infrastructure as Code fundamentals';
$page_description = 'Learn infrastructure as code fundamentals with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fr...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Infrastructure as Code fundamentals', 'description': 'Learn infrastructure as code fundamentals with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fr...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/infrastructure-as-code-fundamentals/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/infrastructure-as-code-fundamentals.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<h1>Infrastructure as Code fundamentals</h1>
<p><small>Forsk Coding School · DevOps · Practical learning guide</small></p>
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Infrastructure as Code fundamentals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
...
<ul><li><a href="<?= blog_url('terraform-state-and-remote-backends') ?>">Terraform state and remote backends</a></li><li><a href="<?= blog_url('aws-iam-policies-and-least-privilege') ?>">AWS IAM policies and least privilege</a></li><li><a href="<?= blog_url('aws-well-architected-framework-for-beginners') ?>">AWS Well Architected Framework for beginners</a></li></ul>
