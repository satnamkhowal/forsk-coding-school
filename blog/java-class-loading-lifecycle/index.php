...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Java class loading lifecycle","description":"Learn java class loading lifecycle with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Fors...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/java-class-loading-lifecycle/"},"image":"https://forskcodingschool.com/blog/images/java-class-loading-lifecycle.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Java class loading lifecycle" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
