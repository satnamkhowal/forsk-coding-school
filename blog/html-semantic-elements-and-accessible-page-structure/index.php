...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"HTML semantic elements and accessible page structure","description":"Learn html semantic elements and accessible page structure with practical explanations, examples, best practices, common mistakes and a clear implementa...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/html-semantic-elements-and-accessible-page-structure/"},"image":"https://forskcodingschool.com/blog/images/html-semantic-elements-and-accessible-page-structure.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="HTML semantic elements and accessible page structure" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
