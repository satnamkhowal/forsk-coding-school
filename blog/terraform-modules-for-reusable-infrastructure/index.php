...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Terraform modules for reusable infrastructure" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
