...
$page_description = 'Learn AWS CloudWatch logs metrics and alarms with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS CloudWatch logs metrics and alarms","description":"Learn AWS CloudWatch logs metrics and alarms with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-cloudwatch-logs-metrics-and-alarms/"},"image":"https://forskcodingschool.com/blog/images/aws-cloudwatch-logs-metrics-and-alarms.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS CloudWatch logs metrics and alarms" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
