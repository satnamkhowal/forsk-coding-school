...
$page_description = 'Learn Azure Functions serverless architecture with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Azure Functions serverless architecture","description":"Learn Azure Functions serverless architecture with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/azure-functions-serverless-architecture/"},"image":"https://forskcodingschool.com/blog/images/azure-functions-serverless-architecture.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Azure Functions serverless architecture" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
