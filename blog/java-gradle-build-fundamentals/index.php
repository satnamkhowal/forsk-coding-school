...
<ul><li><a href="<?= blog_url('c-raii-for-safe-resource-management') ?>">C++ RAII for safe resource management</a></li><li><a href="<?= blog_url('c-references-versus-pointers') ?>">C++ references versus pointers</a></li><li><a href="<?= blog_url('javascript-async-await-debugging') ?>">JavaScript async await debugging</a></li></ul>
