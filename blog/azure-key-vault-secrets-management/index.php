...
$page_description = 'Learn azure key vault secrets management with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fro...';
...
$page_schema = json_encode({'@context': 'https://schema.org', '@type': 'BlogPosting', 'headline': 'Azure Key Vault secrets management', 'description': 'Learn azure key vault secrets management with practical explanations, examples, best practices, common mistakes and a clear implementation checklist fro...', 'author': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'publisher': {'@type': 'Organization', 'name': 'Forsk Coding School'}, 'mainEntityOfPage': {'@type': 'WebPage', '@id': 'https://forskcodingschool.com/blog/azure-key-vault-secrets-management/'}, 'image': 'https://forskcodingschool.com/assets/images/blog/azure-key-vault-secrets-management.webp'}, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<!doctype html>
<html lang="en">
<head>
...
<img src="<?= asset_url('images/blog/' . $slug . '.webp') ?>" alt="Azure Key Vault secrets management" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
