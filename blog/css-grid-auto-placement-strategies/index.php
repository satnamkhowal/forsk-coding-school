...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS grid auto placement strategies" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
