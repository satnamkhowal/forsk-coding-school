...
$page_description = 'Learn AWS S3 lifecycle rules for cost control with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"AWS S3 lifecycle rules for cost control","description":"Learn AWS S3 lifecycle rules for cost control with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/aws-s3-lifecycle-rules-for-cost-control/"},"image":"https://forskcodingschool.com/blog/images/aws-s3-lifecycle-rules-for-cost-control.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AWS S3 lifecycle rules for cost control" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
