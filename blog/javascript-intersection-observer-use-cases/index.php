...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"JavaScript Intersection Observer use cases","description":"Learn javascript intersection observer use cases with practical explanations, examples, best practices, common mistakes and a clear implementation check...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/javascript-intersection-observer-use-cases/"},"image":"https://forskcodingschool.com/blog/images/javascript-intersection-observer-use-cases.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="JavaScript Intersection Observer use cases" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
