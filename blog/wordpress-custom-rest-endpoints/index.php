...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="WordPress custom REST endpoints" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
