...
$page_description = 'Learn Smoke testing versus sanity testing with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Smoke testing versus sanity testing","description":"Learn Smoke testing versus sanity testing with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/smoke-testing-versus-sanity-testing/"},"image":"https://forskcodingschool.com/blog/images/smoke-testing-versus-sanity-testing.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Smoke testing versus sanity testing" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
