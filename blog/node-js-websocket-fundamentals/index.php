...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Node.js WebSocket fundamentals","description":"Learn node.js websocket fundamentals with practical explanations, examples, best practices, common mistakes and a clear implementation checklist from Fo...","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/node-js-websocket-fundamentals/"},"image":"https://forskcodingschool.com/blog/images/node-js-websocket-fundamentals.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Node.js WebSocket fundamentals" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
