...
$page_description = 'Learn Java modules and dependency boundaries with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Java modules and dependency boundaries","description":"Learn Java modules and dependency boundaries with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/java-modules-and-dependency-boundaries/"},"image":"https://forskcodingschool.com/blog/images/java-modules-and-dependency-boundaries.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Java modules and dependency boundaries" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
