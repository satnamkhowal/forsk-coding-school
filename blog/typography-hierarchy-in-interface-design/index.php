...
$page_description = 'Learn Typography hierarchy in interface design with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Typography hierarchy in interface design","description":"Learn Typography hierarchy in interface design with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/typography-hierarchy-in-interface-design/"},"image":"https://forskcodingschool.com/blog/images/typography-hierarchy-in-interface-design.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Typography hierarchy in interface design" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
