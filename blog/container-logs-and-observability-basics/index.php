...
$page_description = 'Learn Container logs and observability basics with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Container logs and observability basics","description":"Learn Container logs and observability basics with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/container-logs-and-observability-basics/"},"image":"https://forskcodingschool.com/blog/images/container-logs-and-observability-basics.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Container logs and observability basics" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
