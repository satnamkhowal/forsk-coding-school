...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="JavaScript optional chaining and nullish coalescing" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
