...
$page_description = 'Learn CSS sticky positioning practical guide with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"CSS sticky positioning practical guide","description":"Learn CSS sticky positioning practical guide with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/css-sticky-positioning-practical-guide/"},"image":"https://forskcodingschool.com/blog/images/css-sticky-positioning-practical-guide.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="CSS sticky positioning practical guide" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
