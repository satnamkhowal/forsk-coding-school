...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="AI model temperature and sampling" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
