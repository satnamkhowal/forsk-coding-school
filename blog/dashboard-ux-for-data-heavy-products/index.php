...
$page_description = 'Learn Dashboard UX for data heavy products with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"Dashboard UX for data heavy products","description":"Learn Dashboard UX for data heavy products with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/dashboard-ux-for-data-heavy-products/"},"image":"https://forskcodingschool.com/blog/images/dashboard-ux-for-data-heavy-products.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="Dashboard UX for data heavy products" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
