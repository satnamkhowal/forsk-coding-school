...
$page_description = 'Learn C++ header files and include guards with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.';
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":"C++ header files and include guards","description":"Learn C++ header files and include guards with practical examples, common mistakes, project guidance and relevant Forsk Coding School courses in Jaipur.","author":{"@type":"Organization","name":"Forsk Coding School"},"publisher":{"@type":"Organization","name":"Forsk Coding School"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://forskcodingschool.com/blog/c-header-files-and-include-guards/"},"image":"https://forskcodingschool.com/blog/images/c-header-files-and-include-guards.webp"}
FORSK_JSON;
?>
<!doctype html>
<html lang="en">
...
<img src="<?= blog_image_url($slug . '.webp') ?>" alt="C++ header files and include guards" loading="eager" style="max-width:100%;height:auto;border-radius:8px">
<article>
