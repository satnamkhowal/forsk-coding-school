...
$page_canonical='';
$page_schema='{"@context": "https://schema.org", "@type": "WebPage", "name": "Forsk Coding School - Forsk Coding School", "description": "Education LMS and Online course template", "url": "https://forskcodingschool.com/login.php"}';
              ...
              <div class="col-12">
                <div class="tj-login-form-wrapper tj-fade-anim">
                  ...
                  <div class="login-social">
                    <a class="tj-social-login-btn" href="login.php#">
                  ...
                  <form class="tj-login-form" action="login.php#" method="post">
                  ...
                  <p class="login-form-footer">Don't have an account? <a href="sign-in.php">Sign up free</a></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="product row ">
            ...
            <div class="col-12 col-md-6 summary entry-summary">
              ...
              <div class="summary-content ps-container ps-theme-wpc">
                ...
                <div class="tj-product-details-query-item d-flex align-items-center">
                  <span>Category: </span> <a href="login.php#">Power</a>
                </div>
                <div class="tj-product-details-query-item d-flex align-items-center">
                  <span>Tag:</span> <a href="login.php#">Portable</a>
                </div>
